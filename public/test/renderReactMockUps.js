...
import { JSONKeyValue, JSONObjectCodeBlock, JSONArrayCodeBlock } from '../components/jsonDisplays.js';
/*
 * A single JSONKeyValue list item.
 */

ReactDOM.render( /*#__PURE__*/React.createElement(JSONKeyValue, {
  attr: "username",
  value: "Bob",
  index: 1,
  length: 1
...
ReactDOM.render( /*#__PURE__*/React.createElement(JSONObjectCodeBlock, {
  object: {
    username: 'Alex',
...
ReactDOM.render( /*#__PURE__*/React.createElement(JSONArrayCodeBlock, {
  array: [{
    username: 'Jim',
    _id: '5f8e713717d4781a685549f5'
  }, {
    username: 'Bob',
    _id: 'ac3e71bc17d4d81a6e5f49f5'
  }]
...
ReactDOM.render( /*#__PURE__*/React.createElement(JSONObjectCodeBlock, {
  object: {
    ...
    _id: '5f8e713717d4781a685549f5',
    log: [{
      description: 'Testing React Mockups',
      duration: 90,
      date: "Tue Aug 25 2069"
    }, {
      description: 'Beer',
      duration: 60,
      date: "Tue Aug 13 1969"
    }, {
      description: 'Donuts',
      duration: 30,
      date: "Tue Aug 08 3000"
    }],
    count: 3
  }
